...
import { Upload, FileDown, Download, Loader2, FileText, Table, Eye, CheckCircle, AlertCircle, Settings, Zap } from "lucide-react";
...
const PdfToExcelPage = () => {
  ...
  const [conversionMode, setConversionMode] = useState("tables");
  ...
  const convertToExcel = async () => {
    ...
    try {
      ...
      for (let i = 0; i < files.length; i++) {
        ...
        setProgressMessage(`Converting ${file.file.name} to Excel...`);
        ...
        try {
          ...
          const mockExcelContent = new Blob(['Mock Excel content'], { 
            type: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet' 
          });
          const url = URL.createObjectURL(mockExcelContent);
          
          converted.push({
            name: fileName,
            url,
            size: formatFileSize(mockExcelContent.size),
      ...
      if (converted.length > 0) {
        ...
        toast.success(`Successfully converted ${converted.length} PDF file${converted.length > 1 ? 's' : ''} to Excel format`);
      }
    ...
    <div className="container mx-auto px-4 py-6 space-y-6 max-w-6xl">
      ...
      <div className="text-center">
        ...
        <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto">
          Extract tables and data from your PDF documents into Excel spreadsheets.
        </p>
      </div>
      ...
      <Card className="border-2 border-dashed border-gray-300 hover:border-green-400 transition-all duration-300">
        <CardContent className="p-6 md:p-8">
          ...
          >
            <div className="mb-6">
              <div className="inline-flex items-center justify-center w-16 h-16 md:w-20 md:h-20 bg-gradient-to-br from-green-500 to-green-700 rounded-full mb-4 shadow-lg">
            ...
            <p className="text-base md:text-lg text-gray-600 mb-6">
              Convert PDF tables and data to Excel format
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <Select value={conversionMode} onValueChange={setConversionMode}>
                  ...
                  <SelectContent>
                    <SelectItem value="tables">Extract Tables Only</SelectItem>
                    <SelectItem value="all">All Text and Data</SelectItem>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <Label htmlFor="preserveFormatting">Preserve cell formatting</Label>
                </div>
                <div className="flex items-center space-x-2">
                  <Checkbox
                    id="oneSheetPerPage"
                  ...
                  />
                  <Label htmlFor="oneSheetPerPage">One sheet per PDF page</Label>
                </div>
              </div>
            </div>
          </CardContent>
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <Button
          ...
          className="flex-1 bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white py-3 text-lg font-semibold"
          size="lg"
        >
          {converting ? (
            <>
      ...
      {files.length === 0 && (
        <Alert className="bg-green-50 border-green-200 max-w-3xl mx-auto">
          ...
          <AlertDescription className="text-green-700">
            <strong>How to convert PDF to Excel:</strong> Upload PDF files containing tables or structured data, configure your extraction settings, then click "Convert to Excel" to create spreadsheet files.
          </AlertDescription>
        </Alert>
      )}
    </div>
