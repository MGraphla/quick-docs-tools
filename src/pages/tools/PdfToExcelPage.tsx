...
import { Upload, FileText, FileSpreadsheet, Download, Settings } from "lucide-react";
...
const PdfToExcelPage = () => {
  ...
  const convertToExcel = async () => {
    ...
    setConvertedFile(`${file.name.replace('.pdf', '')}.${extension}`);
    setConverting(false);
  ...
  const downloadExcel = () => {
    ...
    link.href = '#';
    link.download = convertedFile || 'converted-spreadsheet.xlsx';
    link.click();
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mt-2">Convert PDF tables and data to Excel spreadsheets</p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Select a PDF file with tables or data to convert to Excel
          </CardDescription>
        </CardHeader>
