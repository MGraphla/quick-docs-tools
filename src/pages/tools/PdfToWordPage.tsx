    ...
    <div className="space-y-8 max-w-6xl mx-auto">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <Label htmlFor="preserveImages">Include images and graphics</Label>
                </div>
                <div className="flex items-center space-x-2">
                  <Checkbox
                    id="ocrEnabled"
                  ...
                  />
                  <Label htmlFor="ocrEnabled">OCR for scanned documents</Label>
                </div>
              </div>
            </div>
          </CardContent>
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <Button
          ...
          className="flex-1 bg-gradient-to-r from-orange-600 to-red-600 hover:from-orange-700 hover:to-red-700 text-white py-3 text-lg font-semibold"
          size="lg"
        >
          {converting ? (
            <>
