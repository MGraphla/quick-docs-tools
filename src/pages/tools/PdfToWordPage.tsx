...
import { Upload, FileDown, Download, Loader2, FileText, Type, Eye, CheckCircle, AlertCircle, Settings, Zap } from "lucide-react";
  ...
  const convertToWord = async () => {
    ...
    try {
      ...
      for (let i = 0; i < files.length; i++) {
        ...
        setProgressMessage(`Converting ${file.file.name} to Word...`);
        ...
        try {
          ...
          const mockWordContent = new Blob(['Mock Word document content'], { 
            type: 'application/vnd.openxmlformats-officedocument.wordprocessingml.document' 
          });
          const url = URL.createObjectURL(mockWordContent);
          
          converted.push({
            name: fileName,
            url,
            size: formatFileSize(mockWordContent.size),
    ...
    <div className="container mx-auto px-4 py-6 space-y-6 max-w-6xl">
      ...
      <div className="text-center">
        ...
        <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto">
          Convert your PDF documents to editable Word files with preserved formatting and layout.
        </p>
      </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <Label htmlFor="preserveImages">Include images</Label>
                </div>
              </div>
            </div>
          </CardContent>
      ...
      {files.length === 0 && (
        <Alert className="bg-blue-50 border-blue-200 max-w-3xl mx-auto">
          ...
          <AlertDescription className="text-blue-700">
            <strong>How to convert PDF to Word:</strong> Upload PDF files, configure your conversion settings, then click "Convert to Word" to create editable Word documents.
          </AlertDescription>
        </Alert>
      )}
    </div>
