        ...
        <div className="container mx-auto px-4 py-4">
          <nav className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a href="#tool-info" className="text-sm font-medium transition-all duration-300 hover:text-blue-600 hover:scale-105 text-gray-700">
                Tool Info
              </a>
...
<section id="home" className="container mx-auto px-4 py-20 relative z-10">
      ...
      {/* Tool Info Section */}
      <section id="tool-info" className="py-16 sm:py-24 bg-white relative z-10">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12 sm:mb-16 animate-fade-in">
            <Badge variant="secondary" className="mb-4 sm:mb-6 text-base sm:text-lg px-6 sm:px-8 py-2 sm:py-3 animate-bounce bg-gradient-to-r from-green-100 to-blue-100 text-green-800 font-semibold shadow-lg">
              Featured Tool Information
            </Badge>
            <h2 className="text-3xl sm:text-5xl md:text-6xl font-bold text-gray-900 mb-4 sm:mb-6">
              Explore Our 
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-blue-600"> Professional Tools</span>
            </h2>
            <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto font-medium">
              Get detailed information about each tool, including features, benefits, and step-by-step guides
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            {/* Merge PDF Tool Info */}
            <Card className="group hover:shadow-xl transition-all duration-500 cursor-pointer hover:scale-105 border-0 shadow-lg bg-white/90 backdrop-blur-sm relative overflow-hidden">
              ...
              <CardHeader className="pb-4">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <Badge className="bg-blue-100 text-blue-800 hover:bg-blue-100">Most Popular</Badge>
                </div>
                <CardTitle className="text-xl font-bold text-gray-900">Merge PDF Files</CardTitle>
                <CardDescription className="text-gray-600">
                  Combine multiple PDFs into one seamless document with professional quality
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            {/* Split PDF Tool Info */}
            <Card className="group hover:shadow-xl transition-all duration-500 cursor-pointer hover:scale-105 border-0 shadow-lg bg-white/90 backdrop-blur-sm relative overflow-hidden">
              <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-green-500 to-teal-600"></div>
              <CardHeader className="pb-4">
                <div className="flex items-center gap-3 mb-3">
                  <div className="p-3 bg-green-100 rounded-xl">
                    <Scissors className="h-6 w-6 text-green-600" />
                  </div>
                  <Badge className="bg-green-100 text-green-800 hover:bg-green-100">Essential</Badge>
                </div>
                <CardTitle className="text-xl font-bold text-gray-900">Split PDF Pages</CardTitle>
                <CardDescription className="text-gray-600">
            ...
            <Card className="group hover:shadow-xl transition-all duration-500 cursor-pointer hover:scale-105 border-0 shadow-lg bg-white/90 backdrop-blur-sm relative overflow-hidden">
              ...
              <CardHeader className="pb-4">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <Badge className="bg-purple-100 text-purple-800 hover:bg-purple-100">Powerful</Badge>
                </div>
                <CardTitle className="text-xl font-bold text-gray-900">Compress PDF</CardTitle>
                <CardDescription className="text-gray-600">
                  Reduce file size while maintaining document quality and readability
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-3 mb-4">
          ...
          <div className="text-center mt-12">
            <Link to="/tools">
              <Button variant="outline" size="lg" className="px-8 py-3 text-lg font-semibold hover:scale-105 transition-all duration-300">
